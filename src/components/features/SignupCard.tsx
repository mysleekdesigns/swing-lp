...
export function SignupCard() {
  ...
  return (
    ...
    >
      {/* Glass Morphism Card */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-accent/10 via-background/80 to-background/90 backdrop-blur-3xl border border-accent/30 shadow-[0_0_80px_-12px_rgba(0,0,0,0.5),0_8px_32px_-8px_rgba(0,0,0,0.3),inset_0_1px_0_0_rgba(255,255,255,0.05)]">
